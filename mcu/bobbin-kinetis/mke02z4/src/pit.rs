::bobbin_mcu::periph!( PIT, Pit, PIT_PERIPH, PitPeriph, PIT_OWNED, PIT_REF_COUNT, 0x40037000, 0x00, 0x03);
...
impl PitPeriph {
    ...
    #[inline] pub fn ldval_reg(&self) -> ::bobbin_mcu::register::RegisterArray<Ldval, ::bobbin_bits::R2> { 
        ::bobbin_mcu::register::RegisterArray::new(self.0 as *mut Ldval, 0x100, 0x10)
    }

    #[doc="Get the *mut pointer for the LDVAL register."]
    #[inline] pub fn ldval_mut<I: Into<::bobbin_bits::R2>>(&self, index: I) -> *mut Ldval { 
        self.ldval_reg().ptr(index.into())
    }

    #[doc="Get the *const pointer for the LDVAL register."]
    #[inline] pub fn ldval_ptr<I: Into<::bobbin_bits::R2>>(&self, index: I) -> *const Ldval { 
        self.ldval_reg().ptr(index.into())
    }

    #[doc="Read the LDVAL register."]
    #[inline] pub fn ldval<I: Into<::bobbin_bits::R2>>(&self, index: I) -> Ldval { 
        self.ldval_reg().read(index.into())
    }

    #[doc="Write the LDVAL register."]
    #[inline] pub fn write_ldval<I: Into<::bobbin_bits::R2>>(&self, index: I, value: Ldval) -> &Self {
        self.ldval_reg().write(index.into(), value);
        self
    }

    #[doc="Set the LDVAL register."]
    #[inline] pub fn set_ldval<I: Into<::bobbin_bits::R2>, F: FnOnce(Ldval) -> Ldval>(&self, index: I, f: F) -> &Self {
        self.ldval_reg().set(index.into(), f);
        self
    }

    #[doc="Modify the LDVAL register."]
    #[inline] pub fn with_ldval<I: Into<::bobbin_bits::R2> + Copy, F: FnOnce(Ldval) -> Ldval>(&self, index: I, f: F) -> &Self {
        self.ldval_reg().with(index.into(), f);
        self
    }

    #[doc="Get the CVAL Register."]
    #[inline] pub fn cval_reg(&self) -> ::bobbin_mcu::register::RegisterArray<Cval, ::bobbin_bits::R2> { 
        ::bobbin_mcu::register::RegisterArray::new(self.0 as *mut Cval, 0x104, 0x10)
    }

    #[doc="Get the *mut pointer for the CVAL register."]
    #[inline] pub fn cval_mut<I: Into<::bobbin_bits::R2>>(&self, index: I) -> *mut Cval { 
        self.cval_reg().ptr(index.into())
    }

    #[doc="Get the *const pointer for the CVAL register."]
    #[inline] pub fn cval_ptr<I: Into<::bobbin_bits::R2>>(&self, index: I) -> *const Cval { 
        self.cval_reg().ptr(index.into())
    }

    #[doc="Read the CVAL register."]
    #[inline] pub fn cval<I: Into<::bobbin_bits::R2>>(&self, index: I) -> Cval { 
        self.cval_reg().read(index.into())
    }

    #[doc="Get the TCTRL Register."]
    #[inline] pub fn tctrl_reg(&self) -> ::bobbin_mcu::register::RegisterArray<Tctrl, ::bobbin_bits::R2> { 
        ::bobbin_mcu::register::RegisterArray::new(self.0 as *mut Tctrl, 0x108, 0x10)
    }

    #[doc="Get the *mut pointer for the TCTRL register."]
    #[inline] pub fn tctrl_mut<I: Into<::bobbin_bits::R2>>(&self, index: I) -> *mut Tctrl { 
        self.tctrl_reg().ptr(index.into())
    }

    #[doc="Get the *const pointer for the TCTRL register."]
    #[inline] pub fn tctrl_ptr<I: Into<::bobbin_bits::R2>>(&self, index: I) -> *const Tctrl { 
        self.tctrl_reg().ptr(index.into())
    }

    #[doc="Read the TCTRL register."]
    #[inline] pub fn tctrl<I: Into<::bobbin_bits::R2>>(&self, index: I) -> Tctrl { 
        self.tctrl_reg().read(index.into())
    }

    #[doc="Write the TCTRL register."]
    #[inline] pub fn write_tctrl<I: Into<::bobbin_bits::R2>>(&self, index: I, value: Tctrl) -> &Self {
        self.tctrl_reg().write(index.into(), value);
        self
    }

    #[doc="Set the TCTRL register."]
    #[inline] pub fn set_tctrl<I: Into<::bobbin_bits::R2>, F: FnOnce(Tctrl) -> Tctrl>(&self, index: I, f: F) -> &Self {
        self.tctrl_reg().set(index.into(), f);
        self
    }

    #[doc="Modify the TCTRL register."]
    #[inline] pub fn with_tctrl<I: Into<::bobbin_bits::R2> + Copy, F: FnOnce(Tctrl) -> Tctrl>(&self, index: I, f: F) -> &Self {
        self.tctrl_reg().with(index.into(), f);
        self
    }

    #[doc="Get the TFLG Register."]
    #[inline] pub fn tflg_reg(&self) -> ::bobbin_mcu::register::RegisterArray<Tflg, ::bobbin_bits::R2> { 
        ::bobbin_mcu::register::RegisterArray::new(self.0 as *mut Tflg, 0x10c, 0x10)
    }

    #[doc="Get the *mut pointer for the TFLG register."]
    #[inline] pub fn tflg_mut<I: Into<::bobbin_bits::R2>>(&self, index: I) -> *mut Tflg { 
        self.tflg_reg().ptr(index.into())
    }

    #[doc="Get the *const pointer for the TFLG register."]
    #[inline] pub fn tflg_ptr<I: Into<::bobbin_bits::R2>>(&self, index: I) -> *const Tflg { 
        self.tflg_reg().ptr(index.into())
    }

    #[doc="Read the TFLG register."]
    #[inline] pub fn tflg<I: Into<::bobbin_bits::R2>>(&self, index: I) -> Tflg { 
        self.tflg_reg().read(index.into())
    }

    #[doc="Write the TFLG register."]
    #[inline] pub fn write_tflg<I: Into<::bobbin_bits::R2>>(&self, index: I, value: Tflg) -> &Self {
        self.tflg_reg().write(index.into(), value);
        self
    }

    #[doc="Set the TFLG register."]
    #[inline] pub fn set_tflg<I: Into<::bobbin_bits::R2>, F: FnOnce(Tflg) -> Tflg>(&self, index: I, f: F) -> &Self {
        self.tflg_reg().set(index.into(), f);
        self
    }

    #[doc="Modify the TFLG register."]
    #[inline] pub fn with_tflg<I: Into<::bobbin_bits::R2> + Copy, F: FnOnce(Tflg) -> Tflg>(&self, index: I, f: F) -> &Self {
